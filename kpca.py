...
from sklearn.model_selection import train_test_split #permite hacer una división de un conjunto de 
#datos en dos bloques de entrenamiento y prueba de un modelo
